...
const ChannelsCate = (props: { cateChan: Map<any, any>, categories: string[], setUrl: any, setChannelName: any }) => {
  const { cateChan, categories, setUrl, setChannelName } = props
        ...
        {categories.map((item, index) => {
          return (
            <Button
              ...
              onClick={() => {
                setOpen(true)
                const cateChanData = cateChan.get(item)
